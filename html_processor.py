                        ...
                        for child in children:
                            ...
                            if childtype == 'auto':
                                if childlocation == 'auto:nav':
                                    ...
                                    html.replace("</head>", "<link rel='stylesheet' href='https://dom.tutorialpaths.com/nav/bundle.css'><script src='https://dom.tutorialpaths.com/nav.bundle.js'></script></head>")

                                elif childlocation == 'auto:nav_static':

                                    nav = urlopen("https://dom.tutorialpaths.com/nav/_index.html").read().decode()

                                    html.replace("</head>", "<link rel='stylesheet' href='https://dom.tutorialpaths.com/nav_static/bundle.css'><script src='https://dom.tutorialpaths.com/nav_static.bundle.js'></script></head>")
                                ...
                                html = html.replace("@nav auto:nav auto,", "")
